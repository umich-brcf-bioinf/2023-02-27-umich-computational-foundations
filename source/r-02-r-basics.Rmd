...
on_asia <- c(TRUE, FALSE, FALSE, FALSE)
```
...
> 3. What function can concatenate other values onto a vector?
...
>
> 1. To the `continents` vector add: "South America"
> 2. To the `populations` vector add: 11428245
...
continents
populations <- c(populations, 11428245)
populations
```
</details>
<br>
...
Before we continue, let's reset some vectors:
